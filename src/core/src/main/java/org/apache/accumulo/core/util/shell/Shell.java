...
import org.apache.accumulo.core.util.shell.commands.TeeCommand;
...
public class Shell {
  ...
  public void config(String... args) {
    ...
    Command external[] = {new AboutCommand(), new AddSplitsCommand(), new AuthenticateCommand(), new ByeCommand(), new ClasspathCommand(), new ClearCommand(),
        ...
        new TableCommand(), new TablePermissionsCommand(), new TablesCommand(), new TeeCommand(), new TraceCommand(), new UserCommand(), new UserPermissionsCommand(),
  ...
  public void setTeeTableName(String tableName) {
    this.teeTableName = tableName;
  }
  
  public String getTeeTableName() {
    return this.teeTableName;
  }
